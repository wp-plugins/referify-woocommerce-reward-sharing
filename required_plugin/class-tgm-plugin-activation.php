    ...
    class TGM_Plugin_Activation {
        ...
        public function init() {
            ...
            $this->strings = array(
                ...
                'notice_can_install_required'    => _n_noop( 'The Competition Form Plugin requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'tgmpa' ),
                'notice_can_install_recommended' => _n_noop( 'The Competition Form Plugin recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'tgmpa' ),
                ...
                'notice_can_activate_required'   => _n_noop( 'The following required plugin for The Competition Form is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'tgmpa' ),
                'notice_can_activate_recommended'=> _n_noop( 'The following recommended plugin for The Competition Form is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'tgmpa' ),
 ...
 * @since 2.2.0
 */
add_action( 'admin_init', 'referify_tgmpa_load_bulk_installer' );
function referify_tgmpa_load_bulk_installer() {
